...
from resources.controller import (
    ...
    AdminUserListResource, AdminUtilityListResource, AdminBillListResource, AdminPaymentListResource, PaymentProcessingResource
)
...
api.add_resource(PaymentProcessingResource, '/api/payments/process/<int:current_user_id>')
